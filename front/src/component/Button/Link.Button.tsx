...
export default function ButtonBasic(props: PropsType) {
    ...
    const inactive =
        "pretendard_bold_24 motion_basic inline-flex items-center justify-center rounded-full bg-new-800 w-full py-5 text-center text-base font-medium text-new-500 hover:text-new-500 cursor-not-allowed ";
