...
// SetUUID sets the "uuid" field.
func (m *SubmissionMutation) SetUUID(s string) {
	m.uuid = &s
}

// UUID returns the value of the "uuid" field in the mutation.
func (m *SubmissionMutation) UUID() (r string, exists bool) {
	v := m.uuid
	if v == nil {
		return
	}
...
// OldUUID returns the old "uuid" field's value of the Submission entity.
// If the Submission object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubmissionMutation) OldUUID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUUID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUUID resets all changes to the "uuid" field.
func (m *SubmissionMutation) ResetUUID() {
	m.uuid = nil
}
...
func (m *SubmissionMutation) SetSubmitterID(s string) {
	m.submitter_id = &s
}

// SubmitterID returns the value of the "submitter_id" field in the mutation.
func (m *SubmissionMutation) SubmitterID() (r string, exists bool) {
	v := m.submitter_id
	if v == nil {
		return
	}
...
// OldSubmitterID returns the old "submitter_id" field's value of the Submission entity.
// If the Submission object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubmissionMutation) OldSubmitterID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SubmissionMutation) ResetSubmitterID() {
	m.submitter_id = nil
}
...
func (m *SubmissionMutation) Fields() []string {
	...
	if m.uuid != nil {
		fields = append(fields, submission.FieldUUID)
	}
	if m.code != nil {
		fields = append(fields, submission.FieldCode)
	}
	if m.submitter_id != nil {
		fields = append(fields, submission.FieldSubmitterID)
	}
	return fields
}
