...
func (sq *SubmissionQuery) ForUpdate(opts ...sql.LockOption) *SubmissionQuery {
...
func (sq *SubmissionQuery) ForShare(opts ...sql.LockOption) *SubmissionQuery {
	if sq.driver.Dialect() == dialect.Postgres {
		sq.Unique(false)
	}
	sq.modifiers = append(sq.modifiers, func(s *sql.Selector) {
