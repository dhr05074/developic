...
func (pq *ProblemQuery) loadRecords(ctx context.Context, query *RecordQuery, nodes []*Problem, init func(*Problem), assign func(*Problem, *Record)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(problem.RecordsTable)
		s.Join(joinT).On(s.C(record.FieldID), joinT.C(problem.RecordsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(problem.RecordsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(problem.RecordsPrimaryKey[0]))
